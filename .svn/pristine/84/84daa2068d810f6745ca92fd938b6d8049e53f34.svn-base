...
<script>
    ...
    function setMyData(param) {
        ...
        if (typeof (usecaseDataId) == 'undefined' || usecaseDataId == '' || usecaseDataId == 0) {
            ...
            url = '${ctx}/func/mark/rules/' + usecaseDataId ;
        ...
        $("#dg-rule-list").datagrid({
            ...
            columns: [[
                ...
                {field: 'destFieldId', title: '应答报文域Id', width: 100},
                {field: 'destFieldZh', title: '应答报文域名称', width: 50},
                {field: 'srcFieldId', title: '请求报文域Id', width: 100},
                {field: 'srcFieldZh', title: '请求报文域名称', width: 50}
            ]],
            toolbar: [{
                text: '添加',
                iconCls: 'icon-add',
                handler: function () {
                    $('#window-rule-add').window({
                        ...
                        width: 480,
                        height: 300,
                        href: '${ctx}/func/mark/ruleAddPage/',
                        modal: true,
                        minimizable: false,
                        maximizable: false,
                        shadow: false,
