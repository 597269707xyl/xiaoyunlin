 ...
 */
@Entity
@Table(name = "nxy_func_epcc_mark")
@QueryDef(queryTag = "epccMark", genericQueryFields = {}, sortFields = {"id"}, direction = Sort.Direction.DESC,
        daoName = "nxyFuncEpccMarkDao")
@EntityListeners(value = EntityCodeListener.class)
public class NxyFuncEpccMark {
    @Id
