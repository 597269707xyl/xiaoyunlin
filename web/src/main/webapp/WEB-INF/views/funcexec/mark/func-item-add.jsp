...
<form id="itemForm">
    ...
    <input id="markType" name="type" type="hidden" value="t" class="easyui-textbox form-input"/>
    <input id="mark" name="mark" type="hidden" value="recv" class="easyui-textbox form-input"/>
    <table>
        <tr>
...
<script>
    ...
    function getData(){
        ...
        formData.type = $("#markType").textbox('getValue');
        return formData;
    }
    var type = 'update';
    function onOk() {
