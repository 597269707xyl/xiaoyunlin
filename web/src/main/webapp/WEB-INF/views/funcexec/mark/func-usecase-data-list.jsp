    ...
    function setData(id, itemId) {
        ...
        $("#dg-usecase-data-list").datagrid({
            ...
            columns: [[
                ...
                {field: 'expectedDataList', title: '结果值', width: 60,
                    formatter: function (value, row, index){
                        var msgId = row.messageId;
                        if(msgId == null || msgId == ''){
                            msgId = row.simMessage.id;
                        }
                    return "<a href='#' onclick='showexpecteddata(" + msgId + ","   + row.id +"," + row.expectedDataList + "," + index + ")'>结果值</a>";
                }},
            ...
            toolbar: [{
                ...
                handler: function () {
                    $('#window-msg-list').window({
                        ...
                        width: 680,
                        height: 500,
                        href: '${ctx}/func/mark/msgList?itemId='+itemId+'&usecaseId='+usecaseId,
                        modal: true,
                        minimizable: false,
                        maximizable: false,
                        shadow: false,
