        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin:4px 0">
            ...
            <tr class="menu_lr">
                ...
                <td><a href="#" style="background-color: #E6EFFF;" onclick="addItem();;"><img src="${ctx}/asset/images/btn_add.png" width="16" height="16" alt=""/>添加</a>&nbsp;&nbsp;
                    ...
                    <a href="#" style="background-color: #E6EFFF;" onclick="copyItemToK();"><img src="${ctx}/asset/images/btn_add.png" width="16" height="16" alt=""/>导出</a>
                </td>
            </tr>
            </tbody>
        </table>
                ...
                <table class="easyui-datagrid" id="usecaseList" data-options="">
                    ...
                    <tr>
                        ...
                        <c:if test="${toolType=='atsp'}">
                            ...
                            <th data-options="field:'case_number',width:80">案例编号</th>
...
<script>
    ...
    function addItem(){
        var node = $('#projectTree').tree('getSelected');
        if (node) {
            commonShowWindow(null, '增加功能测试项', '${ctx}/func/exec/addItemPage?type=t&mark=', 400, 220, true, false, false);
        } else {
    ...
    function addUsecase(){
        ...
        commonShowWindow(null, '添加用例', '${ctx}/func/exec/addUsecasePage/' + node.id, 430, 500, true, false, false);
    }
    //修改用例
    function editUsecase(){
        ...
        commonShowWindow(param, '修改用例', '${ctx}/func/exec/addUsecasePage/0', 430, 480, true, false, false);
    }
    //用例查询
    function onSearchs(){
