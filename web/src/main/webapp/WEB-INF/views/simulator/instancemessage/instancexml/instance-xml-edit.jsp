...
<form id="fm-update" method="post" action="#" enctype="multipart/form-data">
            ...
            <tr>
                ...
                <td>
                    <input class="easyui-combobox" id="simname" name="simname" style="width: 200px"
                           data-options="valueField:'id',textField:'text',limitToList:'true',url:'${ctx}/sim/instance/message/getAllsim?type=XML',panelHeight:'auto'"
...
<script>
    ...
    function onOk() {
      ...
      //  var schemaFileid = $("#schemaFilename").combobox('getValue');
        $.messager.progress();
        $.ajax({
            url: '${ctx}/sim/instance/message/updateXmlMessage/' + simid,
            type: 'post',
            data: formData,
            cache: false,
