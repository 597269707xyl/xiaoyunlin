...
<script>
        ...
        $.ajax({
            ...
            success: function (vo) {
                $("#dg-reply-select").datagrid({
                    ...
                    title: '报文列表',
                    fitColumns: true,
                    url:'${ctx}/generic/commonQuery/simSysInsMessage?type=XML&systemInstance.id='+vo.systemInstance.id,
                    height: 300,
                    singleSelect:true,
                    pagination: true,
                    pageSize: 10,
    ...
    function onSetOk(){
        ...
        $('#window-reply-param').window({
            ...
            width: 200,
            height: 130,
            href: '${ctx}/sim/instance/message/listReponseMsgParam?type=XML',
            modal: true,
            minimizable: false,
            maximizable: false,
            shadow: false,
