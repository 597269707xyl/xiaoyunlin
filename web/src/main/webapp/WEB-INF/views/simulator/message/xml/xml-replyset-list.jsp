...
<script>
    ...
    $("#dg-replymessage-select").datagrid({
        title: '选择应答报文',
        fitColumns: true,
        url:'${ctx}/generic/commonQuery/simMessage?type=XML',
        height: 280,
        pagination: true,
        pageSize: 10,
        ...
        columns: [[
            ...
            {field: 'mesgType', title: '应答报文编码', width: 100}
        ]]
    });
    ...
    function onSetOk(){
        ...
        $.post("${ctx}/sim/message/addReplyRule", {requestid: requestid, ids: ids}, function (data) {
            if (data.success) {
                onSetCancel();
            } else {
