    ...
    <div class="popup">
        <table>
            <tr>
                ...
                <td class="popup_input"><input class="easyui-textbox" id="sysName" name="sysName"
                                               data-options="required:true,validType:'length[2,32]'"/></td>
            </tr>
            <tr>
                <td class="popup_label">姓名:</td>
                <td><input class="easyui-textbox" id="name1" name="name" data-options="required:true"/></td>
            ...
            <tr>
                ...
                <td><input class="easyui-passwordbox" id="passWd" name="passWd" value="12345678"
                           data-options="required:true"/></td>
            </tr>
            <tr>
                <td class="popup_label">确认密码:</td>
                <td><input class="easyui-passwordbox" id="checkPsw" name="checkPsw" required="required" value="12345678"
